...
import com.example.myapp1.database.Item
import com.example.myapp1.database.ItemDao
import com.example.myapp1.database.ItemRoomDatabase
...
private operator fun Any.get(java: Class<HomeViewModel>): HomeViewModel {
